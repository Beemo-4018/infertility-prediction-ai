...
"""
====================================================
난임 환자 임신 성공 여부 예측 - v_clean8 (배반포 제거 + 클리닉x나이 TE)
평가 지표  : ROC-AUC
...
CLEAN_FEATURES = [
    ...
    '해동_이식_간격',      # 해동→이식 간격
    # 제거: 배반포_이식추정 (중요도 83, 혼합_이식_간격과 중복)

    # I. 클리닉 x 나이 Target Encoding (leakage 없음)
    '클리닉_나이별성공률', # 클리닉 x 나이그룹 조합 성공률
]
...
if __name__ == '__main__':
    print('=' * 55)
    print('  난임 환자 임신 성공 여부 예측 (v_clean8)')
    print('  피처 수: 19개 (배반포 제거 + 클리닉x나이 TE 추가)')
    print('=' * 55)
