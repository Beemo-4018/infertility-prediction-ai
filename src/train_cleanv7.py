...
"""
====================================================
난임 환자 임신 성공 여부 예측 - v_clean7 (시간 간격 피처 추가)
평가 지표  : ROC-AUC
...
CLEAN_FEATURES = [
    ...
    # H. 시간 간격 피처 (배아 배양 기간 → 임신 성공에 직접 영향)
    '혼합_이식_간격',      # 난자 혼합 → 배아 이식 간격 (배양 기간)
    '배반포_이식추정',     # 혼합→이식 5일 이상 = 배반포 이식 추정
    '해동_이식_간격',      # 배아 해동 → 이식 간격 (동결배아 품질 반영)
]
...
if __name__ == '__main__':
    print('=' * 55)
    print('  난임 환자 임신 성공 여부 예측 (v_clean7)')
    print('  피처 수: 18개 (시간 간격 피처 3개 추가)')
    print('=' * 55)
